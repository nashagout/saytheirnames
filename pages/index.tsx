        ...
        <div>
          <div className="grid grid-cols-1  gap-1 pt-10 pb-6  sm:grid-cols-2 ">
            ...
            <div className=" mx-5 flex 	 flex-col items-end		 ">
              <div>
                <div className=" stat bg-secondary  text-secondary-content  shadow sm:w-[270px]">
                  <div className=" stat	 items-center  self-center justify-self-center">
                    ...
                    <div className="stat-desc">Among the confirmed names.</div>
                  </div>
                </div>
                <div className=" flex-row pt-3">
                  ...
                  >
                    ...
                    <p className="mx-2">Contribute on this website</p>
                  </a>
                </div>
              </div>
            </div>
